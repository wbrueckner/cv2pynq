...
xilinx.com:hls:filter2D_kernel_f:1.0\
...
proc create_hier_cell_image_filters { parentCell nameHier } {
  ...
  # Create instance: filter2D_kernel_f_0, and set properties
  set filter2D_kernel_f_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:filter2D_kernel_f:1.0 filter2D_kernel_f_0 ]

  # Create instance: xlconcat_0, and set properties
  set xlconcat_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 xlconcat_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins filter2D_kernel_f_0/in_stream]
  ...
  connect_bd_intf_net -intf_net filter2D_kernel_f_0_out_stream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins filter2D_kernel_f_0/out_stream]
  connect_bd_intf_net -intf_net s_axi_CONTROL_BUS_1 [get_bd_intf_pins s_axi_CONTROL_BUS] [get_bd_intf_pins filter2D_kernel_f_0/s_axi_CONTROL_BUS]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins filter2D_kernel_f_0/ap_rst_n]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins filter2D_kernel_f_0/ap_clk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins image_filters/s_axi_CONTROL_BUS]
  ...
  connect_bd_intf_net -intf_net s_axi_CONTROL_BUS1_1 [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins image_filters/s_axi_CONTROL_BUS1]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs image_filters/filter2D_kernel_f_0/s_axi_CONTROL_BUS/Reg] SEG_filter2D_kernel_f_0_Reg
